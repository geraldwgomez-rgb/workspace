  ...
  return (
    ...
    >
      <div className="container">
        ...
        {<img 
            src="https://images.unsplash.com/photo-1618005182384-a83a8bd57fbe?auto=format&fit=crop&w=100&h=100&q=80" // Reemplaza por {logoEmpresa} si importas un archivo local
            alt="Logo VOLTTEC" 
            height="35" // Ajusta la altura para que combine perfectamente con el texto
